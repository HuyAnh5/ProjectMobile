...
public class InventoryTetrisTestSpawner : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        inventoryA.TryPlaceItem(assets.pistol, new Vector2Int(1, 0), PlacedObjectTypeSO.Dir.Down);
        inventoryA.TryPlaceItem(assets.ammo, new Vector2Int(3, 0), PlacedObjectTypeSO.Dir.Down);
        inventoryA.TryPlaceItem(assets.pistol, new Vector2Int(1, 3), PlacedObjectTypeSO.Dir.Down);
        //inventoryA.TryPlaceItem(assets.rifle, new Vector2Int(2, 0), PlacedObjectTypeSO.Dir.Down);
