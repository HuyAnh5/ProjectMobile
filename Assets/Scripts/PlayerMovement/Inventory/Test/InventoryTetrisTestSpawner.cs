...
public class InventoryTetrisTestSpawner : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Spawn trên b?ng A
        inventoryA.TryPlaceItem(assets.ammo, new Vector2Int(4, 0), PlacedObjectTypeSO.Dir.Down);
        inventoryA.TryPlaceItem(assets.medkit, new Vector2Int(2, 0), PlacedObjectTypeSO.Dir.Down);
